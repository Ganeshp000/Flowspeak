      ...
      <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 18 }}>
        <div>
          ...
          <p style={{ color: theme.textMuted, fontSize: 14, margin: "8px 0 0" }}>
            Teach FlowSpeak the words, names, and jargon it should always get right.
          </p>
        </div>
        ...
        <Card pad={filtered.length ? 8 : 22}>
          {filtered.length === 0 ? (
            <div style={{ padding: "30px 8px", textAlign: "center", color: theme.textFaint, fontSize: 13.5 }}>
              {entries.length === 0
                ? "No words yet. Add one, or FlowSpeak will auto-learn the terms you correct."
