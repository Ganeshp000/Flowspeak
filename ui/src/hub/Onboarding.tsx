    ...
    >
      <div style={{ width: 560, maxWidth: "100%" }}>
        ...
        <p style={{ color: theme.textMuted, lineHeight: 1.5, margin: "0 0 24px" }}>
          Grant these to <b>FlowSpeak</b>, in order. Each turns green here the moment macOS applies
        ...
        <Step
          n={2}
          title="Microphone"
          detail="Lets FlowSpeak hear what you say."
          done={mic}
          active={acc && !mic}
          locked={!acc}
          required
        ...
        >
          {canEnter ? "Enter FlowSpeak →" : "Grant Accessibility + Microphone to continue"}
        </button>

        <p style={{ fontSize: 12, color: theme.textFaint, lineHeight: 1.5, marginTop: 16 }}>
          If a permission stays grey after you flip it on in System Settings, toggle FlowSpeak off
