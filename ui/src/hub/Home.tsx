...
import { liquidGlass } from "../overlay/liquid-glass";
...
function Banner() {
  ...
  useEffect(() => {
    ...
    const glass = liquidGlass(bannerRef.current, { scale: -80, border: 0.1 });
    ...
    >
      ...
      <div style={{ position: "relative", maxWidth: 460 }}>
        ...
        <p style={{ color: palette.slate300, fontSize: 14, lineHeight: 1.55, margin: "10px 0 0" }}>
          Hold your key, speak, and FlowSpeak types clean text wherever your cursor is.
        </p>
      </div>
    </div>
  );
